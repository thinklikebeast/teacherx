...
import { Pressable,Flex,Center, Text, HStack, Box } from 'native-base'
import Animated, {
  Easing,
  useSharedValue,
  useAnimatedStyle,
...
const AnimatedTaskLabel = memo((props: Props) => {
  ...
  return (
    <Pressable>
      <AnimatedHStack justifyContent="center" alignItems="center" style={{}} style={[hstackAnimatedStyles]}>
        <AnimatedText
          fontSize={19}
          noOfLines={1}
          isTruncated
	...
	<Flex direction="column" mb="2.5" mt="1.5"> 
	  <Pressable><AnimatedText shadow={3} bg="primary.500" m="2" p="2" borderRadius="md">ABSENT:0</AnimatedText></Pressable>
        </Flex>
      </AnimatedHStack>
    </Pressable>
  )
